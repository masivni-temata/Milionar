...
function renderRoztrelQuestion(){
  ...
  .then(data => {
    ...
    document.querySelector('.js-roztrel-answer-a').innerHTML = `<button class="answer-button">${'A: ' + questionData[currentQuestionString].a[0]}</button>`
    document.querySelector('.js-roztrel-answer-b').innerHTML = `<button class="answer-button">${'B: ' + questionData[currentQuestionString].b[0]}</button>`
    document.querySelector('.js-roztrel-answer-c').innerHTML = `<button class="answer-button">${'C: ' + questionData[currentQuestionString].c[0]}</button>`
    document.querySelector('.js-roztrel-answer-d').innerHTML = `<button class="answer-button">${'D: ' + questionData[currentQuestionString].d[0]}</button>`
  });
}
  ...
  if (event.key === 'm' && windowAction === false) {
    fetch("/roztrel-read")
      ...
      .then(data => {
        ...
        document.querySelector('.question-container').innerHTML = `<div class="answer-container">${correctAnswer}</div>` || "Správná odpověď nenalezena.";
      });
  }
});
...
function teamDisplay(){
  for(let i = 0;numberOfTeams>i;i++){
    ...
    <div class="team-stats">
      ...
      <div class="team-${trueNumber}">Čas: ${0}</div>
      <img src="images/team${trueNumber}.png">
    </div>`
  };
};
  ...
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop1")
      ...
      .then(data => {
        ...
        document.querySelector('.team-1').innerHTML = `<div class="team-1">Čas: ${time}</div>`
...
function teamTimeDisplayLoop2(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop2")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-2').innerHTML = `<div class="team-2">Čas: ${time}</div>`
...
function teamTimeDisplayLoop3(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop3")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-3').innerHTML = `<div class="team-3">Čas: ${time}</div>`
...
function teamTimeDisplayLoop4(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop4")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-4').innerHTML = `<div class="team-4">Čas: ${time}</div>`
...
function teamTimeDisplayLoop5(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop5")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-5').innerHTML = `<div class="team-5">Čas: ${time}</div>`
...
function teamTimeDisplayLoop6(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop6")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-6').innerHTML = `<div class="team-6">Čas: ${time}</div>`
...
function teamTimeDisplayLoop7(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop7")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-7').innerHTML = `<div class="team-7">Čas: ${time}</div>`
...
function teamTimeDisplayLoop8(){
  setTimeout(()=>{
    fetch("/teamTimeDisplayLoop8")
      ...
      .then(data => {
        const time = Number(data.fileData);
        document.querySelector('.team-8').innerHTML = `<div class="team-8">Čas: ${time}</div>`
